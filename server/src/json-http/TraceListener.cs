// Copied and modified from https://github.com/serilog-trace-listener/SerilogTraceListener
// The modification was to change how log levels are mapped
        ...
        internal static LogEventLevel ToLogEventLevel(TraceEventType eventType)
        {
            switch (eventType)
            {
                ...
                case TraceEventType.Information:
                  // old machinewatch used Information level for debug messages
                    {
