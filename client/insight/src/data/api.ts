            ...
            if (_data["tools"]) {
                ...
                for (let key in _data["tools"]) {
                    if (_data["tools"].hasOwnProperty(key))
                        this.tools![key] = _data["tools"][key] ? ToolUse.fromJS(_data["tools"][key]) : new ToolUse();
                }
            }
        }
    }
...
export class ProcPathInfo implements IProcPathInfo {
    ...
    init(_data?: any) {
        if (_data) {
            this.pathGroup = _data["PathGroup"];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (_data["Tools"]) {
                ...
                for (let key in _data["Tools"]) {
                    if (_data["Tools"].hasOwnProperty(key))
                        this.tools![key] = _data["Tools"][key];
                }
            }
            ...
            if (_data["Queues"]) {
                ...
                for (let key in _data["Queues"]) {
                    if (_data["Queues"].hasOwnProperty(key))
                        this.queues![key] = _data["Queues"][key] ? QueueSize.fromJS(_data["Queues"][key]) : new QueueSize();
                }
            }
        }
    }
            ...
            if (_data["Paths"]) {
                ...
                for (let key in _data["Paths"]) {
                    if (_data["Paths"].hasOwnProperty(key))
                        this.paths![key] = _data["Paths"][key];
                }
            }
        }
    }
            ...
            if (_data["elapsed-station-time"]) {
                ...
                for (let key in _data["elapsed-station-time"]) {
                    if (_data["elapsed-station-time"].hasOwnProperty(key))
                        this.elapsedStationTime![key] = _data["elapsed-station-time"][key];
                }
            }
            if (_data["active-stat-time"]) {
                ...
                for (let key in _data["active-stat-time"]) {
                    if (_data["active-stat-time"].hasOwnProperty(key))
                        this.activeStatTime![key] = _data["active-stat-time"][key];
                }
            }
        }
    }
            ...
            if (_data["ExtraData"]) {
                ...
                for (let key in _data["ExtraData"]) {
                    if (_data["ExtraData"].hasOwnProperty(key))
                        this.extraData![key] = _data["ExtraData"][key];
                }
            }
            this.elapsed = _data["Elapsed"];
            this.active = _data["Active"];
