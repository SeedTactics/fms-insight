...
export class FmsClient {
    ...
    findInstructions(part: string, type: string, process: number | null | undefined, materialID: number | null | undefined, operatorName: string | null | undefined, pallet: number | undefined, signal?: AbortSignal): Promise<void> {
        ...
        if (part === undefined || part === null)
            throw new globalThis.Error("The parameter 'part' must be defined.");
        ...
        if (pallet === null)
            throw new globalThis.Error("The parameter 'pallet' cannot be null.");
    ...
    printLabel(materialId: number, process: number | undefined, signal?: AbortSignal): Promise<void> {
        ...
        if (process === null)
            throw new globalThis.Error("The parameter 'process' cannot be null.");
    ...
    parseBarcode(barcode: string, queuesToAddTo: string[] | null | undefined, signal?: AbortSignal): Promise<ScannedMaterial | null> {
        ...
        if (barcode === undefined || barcode === null)
            throw new globalThis.Error("The parameter 'barcode' must be defined and cannot be null.");
        else
    ...
    protected processParseBarcode(response: Response): Promise<ScannedMaterial | null> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ScannedMaterial.fromJS(resultData200) : null as any;
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ScannedMaterial | null>(null as any);
    }
...
export class JobsClient {
    ...
    history(startUTC: Date, endUTC: Date, signal?: AbortSignal): Promise<HistoricData> {
        ...
        if (startUTC === undefined || startUTC === null)
            throw new globalThis.Error("The parameter 'startUTC' must be defined and cannot be null.");
        else
            url_ += "startUTC=" + encodeURIComponent(startUTC ? "" + startUTC.toISOString() : "") + "&";
        if (endUTC === undefined || endUTC === null)
            throw new globalThis.Error("The parameter 'endUTC' must be defined and cannot be null.");
        else
    ...
    protected processLatestSchedule(response: Response): Promise<MostRecentSchedule> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = MostRecentSchedule.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
    ...
    unscheduledRebookings(signal?: AbortSignal): Promise<Rebooking[]> {
        let url_ = this.baseUrl + "/api/v1/jobs/unscheduled-rebookings";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUnscheduledRebookings(response: Response): Promise<Rebooking[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(Rebooking.fromJS(item));
            }
            else {
        ...
        return Promise.resolve<Rebooking[]>(null as any);
    }
    ...
    addUnallocatedCastingToQueue(castingName: string, queue: string, qty: number | undefined, operName: string | null | undefined, workorder: string | null | undefined, serials: string[], signal?: AbortSignal): Promise<InProcessMaterial[]> {
        ...
        if (castingName === undefined || castingName === null)
            throw new globalThis.Error("The parameter 'castingName' must be defined.");
        url_ = url_.replace("{castingName}", encodeURIComponent("" + castingName));
        if (queue === undefined || queue === null)
            throw new globalThis.Error("The parameter 'queue' must be defined and cannot be null.");
        else
            url_ += "queue=" + encodeURIComponent("" + queue) + "&";
        if (qty === null)
            throw new globalThis.Error("The parameter 'qty' cannot be null.");
    ...
    getJobPlan(jobUnique: string, signal?: AbortSignal): Promise<HistoricJob> {
        ...
        if (jobUnique === undefined || jobUnique === null)
            throw new globalThis.Error("The parameter 'jobUnique' must be defined.");
    ...
    addUnprocessedMaterialToQueue(jobUnique: string, lastCompletedProcess: number, queue: string, pos: number, operName: string | null | undefined, workorder: string | null | undefined, serial: string, signal?: AbortSignal): Promise<InProcessMaterial> {
        ...
        if (lastCompletedProcess === undefined || lastCompletedProcess === null)
            throw new globalThis.Error("The parameter 'lastCompletedProcess' must be defined and cannot be null.");
        else
        ...
        if (pos === undefined || pos === null)
            throw new globalThis.Error("The parameter 'pos' must be defined and cannot be null.");
        else
...
export class LogClient {
    ...
    recent(lastSeenCounter: number, expectedEndUTCofLastSeen: Date | null | undefined, signal?: AbortSignal): Promise<LogEntry[]> {
        ...
        if (lastSeenCounter === undefined || lastSeenCounter === null)
            throw new globalThis.Error("The parameter 'lastSeenCounter' must be defined and cannot be null.");
        else
    ...
    logForSerial(serial: string, signal?: AbortSignal): Promise<LogEntry[]> {
        ...
        if (serial === undefined || serial === null)
            throw new globalThis.Error("The parameter 'serial' must be defined.");
    ...
    logForWorkorder(workorder: string, signal?: AbortSignal): Promise<LogEntry[]> {
        ...
        if (workorder === undefined || workorder === null)
            throw new globalThis.Error("The parameter 'workorder' must be defined.");
    ...
    setInspectionDecision(materialID: number, inspType: string, process: number | undefined, inspect: boolean, signal?: AbortSignal): Promise<LogEntry> {
        ...
        if (inspType === undefined || inspType === null)
            throw new globalThis.Error("The parameter 'inspType' must be defined.");
    ...
    requestRebooking(partName: string, qty: number | undefined, workorder: string | null | undefined, priority: number | null | undefined, notes: string | undefined, signal?: AbortSignal): Promise<LogEntry> {
        ...
        if (partName === undefined || partName === null)
            throw new globalThis.Error("The parameter 'partName' must be defined and cannot be null.");
        else
    ...
    cancelRebooking(bookingId: string, signal?: AbortSignal): Promise<LogEntry> {
        let url_ = this.baseUrl + "/api/v1/log/events/cancel-rebooking/{bookingId}";
...
export class MachinesClient {
    ...
    getProgramRevisionsInDescendingOrderOfRevision(programName: string, count: number, revisionToStart: number | null | undefined, signal?: AbortSignal): Promise<ProgramRevision[]> {
        ...
        if (programName === undefined || programName === null)
            throw new globalThis.Error("The parameter 'programName' must be defined.");
        url_ = url_.replace("{programName}", encodeURIComponent("" + programName));
        if (count === undefined || count === null)
            throw new globalThis.Error("The parameter 'count' must be defined and cannot be null.");
        else
    ...
    getProgramRevisionContent(programName: string, revision: number, signal?: AbortSignal): Promise<string> {
        ...
        if (revision === undefined || revision === null)
            throw new globalThis.Error("The parameter 'revision' must be defined.");
...
export class FMSInfo implements IFMSInfo {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.licenseExpires = _data["LicenseExpires"] ? new Date(_data["LicenseExpires"].toString()) : undefined as any;
    ...
    toJSON(data?: any) {
        ...
        data["LicenseExpires"] = this.licenseExpires ? this.licenseExpires.toISOString() : undefined as any;
...
export class ServerEvent implements IServerEvent {
    ...
    init(_data?: any) {
        if (_data) {
            this.logEntry = _data["LogEntry"] ? LogEntry.fromJS(_data["LogEntry"]) : undefined as any;
            this.newJobs = _data["NewJobs"] ? NewJobs.fromJS(_data["NewJobs"]) : undefined as any;
            this.newCurrentStatus = _data["NewCurrentStatus"] ? CurrentStatus.fromJS(_data["NewCurrentStatus"]) : undefined as any;
            this.editMaterialInLog = _data["EditMaterialInLog"] ? EditMaterialInLogEvents.fromJS(_data["EditMaterialInLog"]) : undefined as any;
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["LogEntry"] = this.logEntry ? this.logEntry.toJSON() : undefined as any;
        data["NewJobs"] = this.newJobs ? this.newJobs.toJSON() : undefined as any;
        data["NewCurrentStatus"] = this.newCurrentStatus ? this.newCurrentStatus.toJSON() : undefined as any;
        data["EditMaterialInLog"] = this.editMaterialInLog ? this.editMaterialInLog.toJSON() : undefined as any;
        return data;
    }
}
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.material)) {
            ...
            for (let item of this.material)
                data["material"].push(item ? item.toJSON() : undefined as any);
        }
        data["type"] = this.type;
...
export class NewJobs implements INewJobs {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["StationUseForCurrentStatus"])) {
                this.stationUseForCurrentStatus = [] as any;
                for (let item of _data["StationUseForCurrentStatus"])
                    this.stationUseForCurrentStatus!.push(SimulatedStationUtilization.fromJS(item));
            }
            ...
            if (Array.isArray(_data["SimWorkordersFilled"])) {
                this.simWorkordersFilled = [] as any;
                for (let item of _data["SimWorkordersFilled"])
                    this.simWorkordersFilled!.push(WorkorderSimFilled.fromJS(item));
            }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.stationUse)) {
            ...
            for (let item of this.stationUse)
                data["StationUse"].push(item ? item.toJSON() : undefined as any);
        }
        if (Array.isArray(this.stationUseForCurrentStatus)) {
            data["StationUseForCurrentStatus"] = [];
            for (let item of this.stationUseForCurrentStatus)
                data["StationUseForCurrentStatus"].push(item ? item.toJSON() : undefined as any);
        }
        if (Array.isArray(this.simDayUsage)) {
            data["SimDayUsage"] = [];
            for (let item of this.simDayUsage)
                data["SimDayUsage"].push(item ? item.toJSON() : undefined as any);
        }
        if (Array.isArray(this.simWorkordersFilled)) {
            data["SimWorkordersFilled"] = [];
            for (let item of this.simWorkordersFilled)
                data["SimWorkordersFilled"].push(item ? item.toJSON() : undefined as any);
        }
        if (Array.isArray(this.currentUnfilledWorkorders)) {
            ...
            for (let item of this.currentUnfilledWorkorders)
                data["CurrentUnfilledWorkorders"].push(item ? item.toJSON() : undefined as any);
        }
...
export class Job implements IJob {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.routeStartUTC = _data["RouteStartUTC"] ? new Date(_data["RouteStartUTC"].toString()) : undefined as any;
            this.routeEndUTC = _data["RouteEndUTC"] ? new Date(_data["RouteEndUTC"].toString()) : undefined as any;
    ...
    toJSON(data?: any) {
        ...
        data["RouteStartUTC"] = this.routeStartUTC ? this.routeStartUTC.toISOString() : undefined as any;
        data["RouteEndUTC"] = this.routeEndUTC ? this.routeEndUTC.toISOString() : undefined as any;
        ...
        if (Array.isArray(this.procsAndPaths)) {
            ...
            for (let item of this.procsAndPaths)
                data["ProcsAndPaths"].push(item ? item.toJSON() : undefined as any);
        }
        return data;
    }
}
...
export class HoldPattern implements IHoldPattern {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.holdUnholdPatternStartUTC = _data["HoldUnholdPatternStartUTC"] ? new Date(_data["HoldUnholdPatternStartUTC"].toString()) : undefined as any;
    ...
    toJSON(data?: any) {
        ...
        data["HoldUnholdPatternStartUTC"] = this.holdUnholdPatternStartUTC ? this.holdUnholdPatternStartUTC.toISOString() : undefined as any;
        ...
        if (_data) {
            if (Array.isArray(_data["BasketLoadStations"])) {
                ...
                for (let item of _data["BasketLoadStations"])
                    this.basketLoadStations!.push(item);
            }
            this.expectedBasketLoadTime = _data["ExpectedBasketLoadTime"];
            if (Array.isArray(_data["BasketUnloadStations"])) {
                this.basketUnloadStations = [] as any;
                for (let item of _data["BasketUnloadStations"])
                    this.basketUnloadStations!.push(item);
            }
            this.expectedBasketUnloadTime = _data["ExpectedBasketUnloadTime"];
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.basketLoadStations)) {
            ...
            for (let item of this.basketLoadStations)
                data["BasketLoadStations"].push(item);
        }
        data["ExpectedBasketLoadTime"] = this.expectedBasketLoadTime;
        if (Array.isArray(this.basketUnloadStations)) {
            data["BasketUnloadStations"] = [];
            for (let item of this.basketUnloadStations)
                data["BasketUnloadStations"].push(item);
        }
        data["ExpectedBasketUnloadTime"] = this.expectedBasketUnloadTime;
        if (Array.isArray(this.paths)) {
            data["paths"] = [];
            for (let item of this.paths)
                data["paths"].push(item ? item.toJSON() : undefined as any);
        }
        return data;
    }
}
...
export class ProcPathInfo implements IProcPathInfo {
    ...
    simulatedStartTimePerPallet?: { [key: string]: Date; } | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (_data["SimulatedStartTimePerPallet"]) {
                this.simulatedStartTimePerPallet = {} as any;
                for (let key in _data["SimulatedStartTimePerPallet"]) {
                    if (_data["SimulatedStartTimePerPallet"].hasOwnProperty(key))
                        (this.simulatedStartTimePerPallet as any)![key] = _data["SimulatedStartTimePerPallet"][key] ? new Date(_data["SimulatedStartTimePerPallet"][key].toString()) : undefined as any;
                }
            }
            this.simulatedStartingUTC = _data["SimulatedStartingUTC"] ? new Date(_data["SimulatedStartingUTC"].toString()) : undefined as any;
            this.simulatedAverageFlowTime = _data["SimulatedAverageFlowTime"];
            this.holdMachining = _data["HoldMachining"] ? HoldPattern.fromJS(_data["HoldMachining"]) : undefined as any;
            this.holdLoadUnload = _data["HoldLoadUnload"] ? HoldPattern.fromJS(_data["HoldLoadUnload"]) : undefined as any;
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.simulatedProduction)) {
            ...
            for (let item of this.simulatedProduction)
                data["SimulatedProduction"].push(item ? item.toJSON() : undefined as any);
        }
        if (this.simulatedStartTimePerPallet) {
            ...
            for (let key in this.simulatedStartTimePerPallet) {
                if (this.simulatedStartTimePerPallet.hasOwnProperty(key))
                    (data["SimulatedStartTimePerPallet"] as any)[key] = this.simulatedStartTimePerPallet[key] ? this.simulatedStartTimePerPallet[key].toISOString() : undefined as any;
            }
        }
        data["SimulatedStartingUTC"] = this.simulatedStartingUTC ? this.simulatedStartingUTC.toISOString() : undefined as any;
        data["SimulatedAverageFlowTime"] = this.simulatedAverageFlowTime;
        data["HoldMachining"] = this.holdMachining ? this.holdMachining.toJSON() : undefined as any;
        data["HoldLoadUnload"] = this.holdLoadUnload ? this.holdLoadUnload.toJSON() : undefined as any;
        ...
        if (Array.isArray(this.inspections)) {
            ...
            for (let item of this.inspections)
                data["Inspections"].push(item ? item.toJSON() : undefined as any);
        }
...
export class SimulatedProduction implements ISimulatedProduction {
    ...
    init(_data?: any) {
        if (_data) {
            this.timeUTC = _data["TimeUTC"] ? new Date(_data["TimeUTC"].toString()) : undefined as any;
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["TimeUTC"] = this.timeUTC ? this.timeUTC.toISOString() : undefined as any;
...
export class WorkorderSimFilled implements IWorkorderSimFilled {
    workorderId!: string;
    part!: string;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.filled = _data["Filled"] ? new Date(_data["Filled"].toString()) : undefined as any;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["Part"] = this.part;
        data["Started"] = this.started ? formatDate(this.started) : undefined as any;
        data["Filled"] = this.filled ? formatDate(this.filled) : undefined as any;
        return data;
    }
}
...
export class CurrentStatus implements ICurrentStatus {
    ...
    init(_data?: any) {
        if (_data) {
            this.timeOfCurrentStatusUTC = _data["TimeOfCurrentStatusUTC"] ? new Date(_data["TimeOfCurrentStatusUTC"].toString()) : undefined as any;
            if (_data["Jobs"]) {
                this.jobs = {} as any;
                for (let key in _data["Jobs"]) {
                    if (_data["Jobs"].hasOwnProperty(key))
                        (this.jobs as any)![key] = _data["Jobs"][key] ? ActiveJob.fromJS(_data["Jobs"][key]) : new ActiveJob();
                }
            }
            if (_data["Pallets"]) {
                this.pallets = {} as any;
                for (let key in _data["Pallets"]) {
                    if (_data["Pallets"].hasOwnProperty(key))
                        (this.pallets as any)![key] = _data["Pallets"][key] ? PalletStatus.fromJS(_data["Pallets"][key]) : new PalletStatus();
                }
            }
            if (Array.isArray(_data["Material"])) {
                this.material = [] as any;
            ...
            if (_data["Queues"]) {
                ...
                for (let key in _data["Queues"]) {
                    if (_data["Queues"].hasOwnProperty(key))
                        (this.queues as any)![key] = _data["Queues"][key] ? QueueInfo.fromJS(_data["Queues"][key]) : new QueueInfo();
                }
            }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["TimeOfCurrentStatusUTC"] = this.timeOfCurrentStatusUTC ? this.timeOfCurrentStatusUTC.toISOString() : undefined as any;
        if (this.jobs) {
            data["Jobs"] = {};
            for (let key in this.jobs) {
                if (this.jobs.hasOwnProperty(key))
                    (data["Jobs"] as any)[key] = this.jobs[key] ? this.jobs[key].toJSON() : undefined as any;
            }
        }
        if (this.pallets) {
            data["Pallets"] = {};
            for (let key in this.pallets) {
                if (this.pallets.hasOwnProperty(key))
                    (data["Pallets"] as any)[key] = this.pallets[key] ? this.pallets[key].toJSON() : undefined as any;
            }
        }
        if (Array.isArray(this.material)) {
            data["Material"] = [];
        ...
        if (this.queues) {
            ...
            for (let key in this.queues) {
                if (this.queues.hasOwnProperty(key))
                    (data["Queues"] as any)[key] = this.queues[key] ? this.queues[key].toJSON() : undefined as any;
            }
        }
        if (Array.isArray(this.machineLocations)) {
            data["MachineLocations"] = [];
            for (let item of this.machineLocations)
                data["MachineLocations"].push(item ? item.toJSON() : undefined as any);
        }
...
export class HistoricJob extends Job implements IHistoricJob {
    ...
    static override fromJS(data: any): HistoricJob {
        data = typeof data === 'object' ? data : {};
    ...
    override toJSON(data?: any) {
        ...
        if (Array.isArray(this.decrements)) {
            ...
            for (let item of this.decrements)
                data["Decrements"].push(item ? item.toJSON() : undefined as any);
        }
        super.toJSON(data);
        return data;
    }
...
export class ActiveJob extends HistoricJob implements IActiveJob {
    ...
    static override fromJS(data: any): ActiveJob {
        data = typeof data === 'object' ? data : {};
...
export class PalletStatus implements IPalletStatus {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.targetLocation = _data["TargetLocation"] ? PalletLocation.fromJS(_data["TargetLocation"]) : undefined as any;
    ...
    toJSON(data?: any) {
        ...
        data["CurrentPalletLocation"] = this.currentPalletLocation ? this.currentPalletLocation.toJSON() : undefined as any;
        ...
        data["TargetLocation"] = this.targetLocation ? this.targetLocation.toJSON() : undefined as any;
...
export class ActiveWorkorder implements IActiveWorkorder {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.dueDate = _data["DueDate"] ? new Date(_data["DueDate"].toString()) : undefined as any;
            this.priority = _data["Priority"];
            this.simulatedStart = _data["SimulatedStart"] ? new Date(_data["SimulatedStart"].toString()) : undefined as any;
            this.simulatedFilled = _data["SimulatedFilled"] ? new Date(_data["SimulatedFilled"].toString()) : undefined as any;
            ...
            if (_data["ElapsedStationTime"]) {
                ...
                for (let key in _data["ElapsedStationTime"]) {
                    if (_data["ElapsedStationTime"].hasOwnProperty(key))
                        (this.elapsedStationTime as any)![key] = _data["ElapsedStationTime"][key];
                }
            }
            if (_data["ActiveStationTime"]) {
                ...
                for (let key in _data["ActiveStationTime"]) {
                    if (_data["ActiveStationTime"].hasOwnProperty(key))
                        (this.activeStationTime as any)![key] = _data["ActiveStationTime"][key];
                }
            }
            if (Array.isArray(_data["Material"])) {
                this.material = [] as any;
    ...
    toJSON(data?: any) {
        ...
        data["DueDate"] = this.dueDate ? this.dueDate.toISOString() : undefined as any;
        data["Priority"] = this.priority;
        data["SimulatedStart"] = this.simulatedStart ? formatDate(this.simulatedStart) : undefined as any;
        data["SimulatedFilled"] = this.simulatedFilled ? formatDate(this.simulatedFilled) : undefined as any;
        ...
        if (this.elapsedStationTime) {
            ...
            for (let key in this.elapsedStationTime) {
                if (this.elapsedStationTime.hasOwnProperty(key))
                    (data["ElapsedStationTime"] as any)[key] = (this.elapsedStationTime as any)[key];
            }
        }
        if (this.activeStationTime) {
            ...
            for (let key in this.activeStationTime) {
                if (this.activeStationTime.hasOwnProperty(key))
                    (data["ActiveStationTime"] as any)[key] = (this.activeStationTime as any)[key];
            }
        }
        if (Array.isArray(this.material)) {
            data["Material"] = [];
...
export enum WorkorderSerialCloseout {
    None = "None",
    ClosedOut = "ClosedOut",
...
export class ScannedMaterial implements IScannedMaterial {
    ...
    init(_data?: any) {
        if (_data) {
            this.existingMaterial = _data["ExistingMaterial"] ? MaterialDetails.fromJS(_data["ExistingMaterial"]) : undefined as any;
            this.potentialNewMaterial = _data["PotentialNewMaterial"] ? ScannedPotentialNewMaterial.fromJS(_data["PotentialNewMaterial"]) : undefined as any;
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["ExistingMaterial"] = this.existingMaterial ? this.existingMaterial.toJSON() : undefined as any;
        data["PotentialNewMaterial"] = this.potentialNewMaterial ? this.potentialNewMaterial.toJSON() : undefined as any;
        return data;
    }
}
            ...
            if (_data["Paths"]) {
                ...
                for (let key in _data["Paths"]) {
                    if (_data["Paths"].hasOwnProperty(key))
                        (this.paths as any)![key] = _data["Paths"][key];
                }
            }
        }
    }
        ...
        if (this.paths) {
            ...
            for (let key in this.paths) {
                if (this.paths.hasOwnProperty(key))
                    (data["Paths"] as any)[key] = (this.paths as any)[key];
            }
        }
        return data;
    }
            ...
            if (_data["PossibleCastingsByQueue"]) {
                ...
                for (let key in _data["PossibleCastingsByQueue"]) {
                    if (_data["PossibleCastingsByQueue"].hasOwnProperty(key))
                        (this.possibleCastingsByQueue as any)![key] = _data["PossibleCastingsByQueue"][key] !== undefined ? _data["PossibleCastingsByQueue"][key] : [];
                }
            }
            if (_data["PossibleJobsByQueue"]) {
                ...
                for (let key in _data["PossibleJobsByQueue"]) {
                    if (_data["PossibleJobsByQueue"].hasOwnProperty(key))
                        (this.possibleJobsByQueue as any)![key] = _data["PossibleJobsByQueue"][key] ? _data["PossibleJobsByQueue"][key].map((i: any) => PossibleJobAndProcess.fromJS(i)) : [];
                }
            }
            this.workorder = _data["Workorder"];
            this.serial = _data["Serial"];
        ...
        if (this.possibleCastingsByQueue) {
            ...
            for (let key in this.possibleCastingsByQueue) {
                if (this.possibleCastingsByQueue.hasOwnProperty(key))
                    (data["PossibleCastingsByQueue"] as any)[key] = (this.possibleCastingsByQueue as any)[key];
            }
        }
        if (this.possibleJobsByQueue) {
            ...
            for (let key in this.possibleJobsByQueue) {
                if (this.possibleJobsByQueue.hasOwnProperty(key))
                    (data["PossibleJobsByQueue"] as any)[key] = (this.possibleJobsByQueue as any)[key];
            }
        }
        data["Workorder"] = this.workorder;
        data["Serial"] = this.serial;
    ...
    init(_data?: any) {
        if (_data) {
            if (_data["Jobs"]) {
                ...
                for (let key in _data["Jobs"]) {
                    if (_data["Jobs"].hasOwnProperty(key))
                        (this.jobs as any)![key] = _data["Jobs"][key] ? HistoricJob.fromJS(_data["Jobs"][key]) : new HistoricJob();
                }
            }
            if (Array.isArray(_data["StationUse"])) {
                this.stationUse = [] as any;
...
export class RecentHistoricData extends HistoricData implements IRecentHistoricData {
    ...
    static override fromJS(data: any): RecentHistoricData {
        data = typeof data === 'object' ? data : {};
    ...
    override toJSON(data?: any) {
        ...
        if (Array.isArray(this.mostRecentSimDayUsage)) {
            ...
            for (let item of this.mostRecentSimDayUsage)
                data["MostRecentSimDayUsage"].push(item ? item.toJSON() : undefined as any);
        }
        super.toJSON(data);
        return data;
    }
...
export class MostRecentSchedule implements IMostRecentSchedule {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["UnscheduledRebookings"])) {
                ...
                for (let item of _data["UnscheduledRebookings"])
                    this.unscheduledRebookings!.push(Rebooking.fromJS(item));
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.unscheduledRebookings)) {
            ...
            for (let item of this.unscheduledRebookings)
                data["UnscheduledRebookings"].push(item ? item.toJSON() : undefined as any);
        }
        return data;
    }
}
...
export class SimulationResults implements ISimulationResults {
    scheduleId!: string;
    jobs!: Job[];
    newExtraParts?: { [key: string]: number; } | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (_data["NewExtraParts"]) {
                this.newExtraParts = {} as any;
                for (let key in _data["NewExtraParts"]) {
                    if (_data["NewExtraParts"].hasOwnProperty(key))
                        (this.newExtraParts as any)![key] = _data["NewExtraParts"][key];
                }
            }
            if (Array.isArray(_data["SimStations"])) {
                this.simStations = [] as any;
                for (let item of _data["SimStations"])
                    this.simStations!.push(SimulatedStationUtilization.fromJS(item));
            }
            if (Array.isArray(_data["SimStationsForExecutionOfCurrentStatus"])) {
                this.simStationsForExecutionOfCurrentStatus = [] as any;
                for (let item of _data["SimStationsForExecutionOfCurrentStatus"])
                    this.simStationsForExecutionOfCurrentStatus!.push(SimulatedStationUtilization.fromJS(item));
            }
            if (Array.isArray(_data["SimDayUsage"])) {
                this.simDayUsage = [] as any;
                for (let item of _data["SimDayUsage"])
    ...
    toJSON(data?: any) {
        ...
        if (this.newExtraParts) {
            data["NewExtraParts"] = {};
            for (let key in this.newExtraParts) {
                if (this.newExtraParts.hasOwnProperty(key))
                    (data["NewExtraParts"] as any)[key] = (this.newExtraParts as any)[key];
            }
        }
        if (Array.isArray(this.simStations)) {
            data["SimStations"] = [];
            for (let item of this.simStations)
                data["SimStations"].push(item ? item.toJSON() : undefined as any);
        }
        if (Array.isArray(this.simStationsForExecutionOfCurrentStatus)) {
            data["SimStationsForExecutionOfCurrentStatus"] = [];
            for (let item of this.simStationsForExecutionOfCurrentStatus)
                data["SimStationsForExecutionOfCurrentStatus"].push(item ? item.toJSON() : undefined as any);
        }
        if (Array.isArray(this.simDayUsage)) {
            data["SimDayUsage"] = [];
            for (let item of this.simDayUsage)
...
export class ToolInMachine extends ToolSnapshot implements IToolInMachine {
    ...
    static override fromJS(data: any): ToolInMachine {
        data = typeof data === 'object' ? data : {};
