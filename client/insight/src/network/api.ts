...
export class FmsClient {
  ...
  findInstructions(
    ...
    if (pallet === null) throw new globalThis.Error("The parameter 'pallet' cannot be null.");
  ...
  printLabel(materialId: number, process: number | undefined, signal?: AbortSignal): Promise<void> {
    ...
    if (process === null) throw new globalThis.Error("The parameter 'process' cannot be null.");
  ...
  parseBarcode(
    barcode: string,
    queuesToAddTo: string[] | null | undefined,
    signal?: AbortSignal,
  ): Promise<ScannedMaterial | null> {
    ...
    else url_ += "barcode=" + encodeURIComponent("" + barcode) + "&";
...
export class JobsClient {
  ...
  filteredHistory(
    startUTC: Date,
    endUTC: Date,
    alreadyKnownSchIds: string[] | undefined,
    signal?: AbortSignal,
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any;
          for (let item of resultData200) result200!.push(Rebooking.fromJS(item));
        } else {
  ...
  addUnallocatedCastingToQueue(
    ...
    else url_ += "queue=" + encodeURIComponent("" + queue) + "&";
    if (qty === null) throw new globalThis.Error("The parameter 'qty' cannot be null.");
  ...
  addUnprocessedMaterialToQueue(
    ...
    if (lastCompletedProcess === undefined || lastCompletedProcess === null)
      throw new globalThis.Error(
        "The parameter 'lastCompletedProcess' must be defined and cannot be null.",
      );
  ...
  decrementQuantities(
    ...
    if (loadDecrementsAfterTimeUTC !== undefined && loadDecrementsAfterTimeUTC !== null)
      url_ +=
        ...
        encodeURIComponent(
          loadDecrementsAfterTimeUTC ? "" + loadDecrementsAfterTimeUTC.toISOString() : "",
        ) +
        "&";
    url_ = url_.replace(/[?&]$/, "");
...
export class LogClient {
  ...
  recent(
    ...
    if (lastSeenCounter === undefined || lastSeenCounter === null)
      throw new globalThis.Error(
        "The parameter 'lastSeenCounter' must be defined and cannot be null.",
      );
    ...
    if (expectedEndUTCofLastSeen !== undefined && expectedEndUTCofLastSeen !== null)
      url_ +=
        ...
        encodeURIComponent(
          expectedEndUTCofLastSeen ? "" + expectedEndUTCofLastSeen.toISOString() : "",
        ) +
        "&";
    url_ = url_.replace(/[?&]$/, "");
  ...
  requestRebooking(
    ...
    else url_ += "partName=" + encodeURIComponent("" + partName) + "&";
    if (qty === null) throw new globalThis.Error("The parameter 'qty' cannot be null.");
    else if (qty !== undefined) url_ += "qty=" + encodeURIComponent("" + qty) + "&";
    if (workorder !== undefined && workorder !== null)
      url_ += "workorder=" + encodeURIComponent("" + workorder) + "&";
...
export class MachinesClient {
  ...
  protected processGetProgramsInCellController(
    response: Response,
  ): Promise<ProgramInCellController[]> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
...
export class MaterialProcessActualPath implements IMaterialProcessActualPath {
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.stops)) {
      data["Stops"] = [];
      for (let item of this.stops) data["Stops"].push(item ? item.toJSON() : (undefined as any));
    }
...
export class NewJobs implements INewJobs {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["AllocationWarning"])) {
        ...
        for (let item of _data["AllocationWarning"]) this.allocationWarning!.push(item);
      }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.jobs)) {
      data["Jobs"] = [];
      for (let item of this.jobs) data["Jobs"].push(item ? item.toJSON() : (undefined as any));
    }
    if (this.extraParts) {
      data["ExtraParts"] = {};
    ...
    if (Array.isArray(this.allocationWarning)) {
      ...
      for (let item of this.allocationWarning) data["AllocationWarning"].push(item);
    }
...
export class ProcessInfo implements IProcessInfo {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["BasketUnloadStations"])) {
        ...
        for (let item of _data["BasketUnloadStations"]) this.basketUnloadStations!.push(item);
      }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.basketUnloadStations)) {
      ...
      for (let item of this.basketUnloadStations) data["BasketUnloadStations"].push(item);
    }
    data["ExpectedBasketUnloadTime"] = this.expectedBasketUnloadTime;
    if (Array.isArray(this.paths)) {
      data["paths"] = [];
      for (let item of this.paths) data["paths"].push(item ? item.toJSON() : (undefined as any));
    }
    return data;
  }
}
      ...
      if (_data["SimulatedStartTimePerPallet"]) {
        ...
        for (let key in _data["SimulatedStartTimePerPallet"]) {
          if (_data["SimulatedStartTimePerPallet"].hasOwnProperty(key))
            (this.simulatedStartTimePerPallet as any)![key] = _data["SimulatedStartTimePerPallet"][
              key
            ]
    ...
    if (this.simulatedStartTimePerPallet) {
      ...
      for (let key in this.simulatedStartTimePerPallet) {
        if (this.simulatedStartTimePerPallet.hasOwnProperty(key))
          (data["SimulatedStartTimePerPallet"] as any)[key] = this.simulatedStartTimePerPallet[key]
...
export class SimulatedStationUtilization implements ISimulatedStationUtilization {
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.parts)) {
      data["Parts"] = [];
      for (let item of this.parts) data["Parts"].push(item ? item.toJSON() : (undefined as any));
    }
    return data;
  }
}
      ...
      if (_data["Jobs"]) {
        ...
        for (let key in _data["Jobs"]) {
          if (_data["Jobs"].hasOwnProperty(key))
            (this.jobs as any)![key] = _data["Jobs"][key]
      ...
      if (_data["Pallets"]) {
        ...
        for (let key in _data["Pallets"]) {
          if (_data["Pallets"].hasOwnProperty(key))
            (this.pallets as any)![key] = _data["Pallets"][key]
      ...
      if (_data["Queues"]) {
        ...
        for (let key in _data["Queues"]) {
          if (_data["Queues"].hasOwnProperty(key))
            (this.queues as any)![key] = _data["Queues"][key]
      ...
      if (_data["Baskets"]) {
        ...
        for (let key in _data["Baskets"]) {
          if (_data["Baskets"].hasOwnProperty(key))
            (this.baskets as any)![key] = _data["Baskets"][key]
    ...
    if (this.jobs) {
      ...
      for (let key in this.jobs) {
        if (this.jobs.hasOwnProperty(key))
          (data["Jobs"] as any)[key] = this.jobs[key]
    ...
    if (this.pallets) {
      ...
      for (let key in this.pallets) {
        if (this.pallets.hasOwnProperty(key))
          (data["Pallets"] as any)[key] = this.pallets[key]
    ...
    if (this.queues) {
      ...
      for (let key in this.queues) {
        if (this.queues.hasOwnProperty(key))
          (data["Queues"] as any)[key] = this.queues[key]
    ...
    if (this.baskets) {
      ...
      for (let key in this.baskets) {
        if (this.baskets.hasOwnProperty(key))
          (data["Baskets"] as any)[key] = this.baskets[key]
...
export class ActiveWorkorder implements IActiveWorkorder {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["Material"])) {
        this.material = [] as any;
        for (let item of _data["Material"]) this.material!.push(WorkorderMaterial.fromJS(item));
      }
    }
  }
    ...
    if (_data) {
      ...
      if (_data["Paths"]) {
        ...
        for (let key in _data["Paths"]) {
          if (_data["Paths"].hasOwnProperty(key)) (this.paths as any)![key] = _data["Paths"][key];
        }
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (this.paths) {
      ...
      for (let key in this.paths) {
        if (this.paths.hasOwnProperty(key)) (data["Paths"] as any)[key] = (this.paths as any)[key];
      }
    }
    return data;
  }
      ...
      if (_data["PossibleCastingsByQueue"]) {
        ...
        for (let key in _data["PossibleCastingsByQueue"]) {
          if (_data["PossibleCastingsByQueue"].hasOwnProperty(key))
            (this.possibleCastingsByQueue as any)![key] =
      ...
      if (_data["PossibleJobsByQueue"]) {
        ...
        for (let key in _data["PossibleJobsByQueue"]) {
          if (_data["PossibleJobsByQueue"].hasOwnProperty(key))
            (this.possibleJobsByQueue as any)![key] = _data["PossibleJobsByQueue"][key]
              ? _data["PossibleJobsByQueue"][key].map((i: any) => PossibleJobAndProcess.fromJS(i))
              : [];
        }
      }
      this.workorder = _data["Workorder"];
    ...
    if (this.possibleCastingsByQueue) {
      ...
      for (let key in this.possibleCastingsByQueue) {
        if (this.possibleCastingsByQueue.hasOwnProperty(key))
          (data["PossibleCastingsByQueue"] as any)[key] = (this.possibleCastingsByQueue as any)[
            key
          ];
      }
    }
    ...
    if (_data) {
      ...
      if (Array.isArray(_data["SimStationsForExecutionOfCurrentStatus"])) {
        ...
        for (let item of _data["SimStationsForExecutionOfCurrentStatus"])
          this.simStationsForExecutionOfCurrentStatus!.push(
            SimulatedStationUtilization.fromJS(item),
          );
      }
      if (Array.isArray(_data["SimDayUsage"])) {
        this.simDayUsage = [] as any;
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.simStationsForExecutionOfCurrentStatus)) {
      ...
      for (let item of this.simStationsForExecutionOfCurrentStatus)
        data["SimStationsForExecutionOfCurrentStatus"].push(
