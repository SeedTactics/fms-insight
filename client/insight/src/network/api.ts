...
export class FmsClient {
    ...
    protected processParseBarcode(response: Response): Promise<ScannedMaterial | null> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ScannedMaterial.fromJS(resultData200) : <any>null;
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
...
export class JobsClient {
    ...
    addUnallocatedCastingToQueue(castingName: string, queue: string, qty: number | undefined, operName: string | null | undefined, workorder: string | null | undefined, serials: string[], signal?: AbortSignal): Promise<InProcessMaterial[]> {
        ...
        if (queue === undefined || queue === null)
            throw new Error("The parameter 'queue' must be defined and cannot be null.");
        else
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.material)) {
            ...
            for (let item of this.material)
                data["material"].push(item ? item.toJSON() : <any>undefined);
        }
        data["type"] = this.type;
        ...
        if (Array.isArray(this.tooluse)) {
            ...
            for (let item of this.tooluse)
                data["tooluse"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
}
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.jobs)) {
            ...
            for (let item of this.jobs)
                data["Jobs"].push(item ? item.toJSON() : <any>undefined);
        }
        if (this.extraParts) {
            data["ExtraParts"] = {};
        ...
        if (Array.isArray(this.stationUse)) {
            ...
            for (let item of this.stationUse)
                data["StationUse"].push(item ? item.toJSON() : <any>undefined);
        }
        if (Array.isArray(this.stationUseForCurrentStatus)) {
            ...
            for (let item of this.stationUseForCurrentStatus)
                data["StationUseForCurrentStatus"].push(item ? item.toJSON() : <any>undefined);
        }
        if (Array.isArray(this.simDayUsage)) {
            data["SimDayUsage"] = [];
            for (let item of this.simDayUsage)
                data["SimDayUsage"].push(item ? item.toJSON() : <any>undefined);
        }
        if (Array.isArray(this.simWorkordersFilled)) {
            data["SimWorkordersFilled"] = [];
            for (let item of this.simWorkordersFilled)
                data["SimWorkordersFilled"].push(item ? item.toJSON() : <any>undefined);
        }
        if (Array.isArray(this.currentUnfilledWorkorders)) {
            ...
            for (let item of this.currentUnfilledWorkorders)
                data["CurrentUnfilledWorkorders"].push(item ? item.toJSON() : <any>undefined);
        }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.procsAndPaths)) {
            ...
            for (let item of this.procsAndPaths)
                data["ProcsAndPaths"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
}
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.paths)) {
            ...
            for (let item of this.paths)
                data["paths"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
}
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.simulatedProduction)) {
            ...
            for (let item of this.simulatedProduction)
                data["SimulatedProduction"].push(item ? item.toJSON() : <any>undefined);
        }
        ...
        if (Array.isArray(this.inspections)) {
            ...
            for (let item of this.inspections)
                data["Inspections"].push(item ? item.toJSON() : <any>undefined);
        }
...
export class WorkorderSimFilled implements IWorkorderSimFilled {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.filled = _data["Filled"] ? new Date(_data["Filled"].toString()) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["Part"] = this.part;
        data["Started"] = this.started ? formatDate(this.started) : <any>undefined;
        data["Filled"] = this.filled ? formatDate(this.filled) : <any>undefined;
        return data;
    }
}
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.machineLocations)) {
            ...
            for (let item of this.machineLocations)
                data["MachineLocations"].push(item ? item.toJSON() : <any>undefined);
        }
        if (Array.isArray(this.workorders)) {
            data["Workorders"] = [];
            for (let item of this.workorders)
                data["Workorders"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
}
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.decrements)) {
            ...
            for (let item of this.decrements)
                data["Decrements"].push(item ? item.toJSON() : <any>undefined);
        }
        super.toJSON(data);
        return data;
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.editedEvents)) {
            ...
            for (let item of this.editedEvents)
                data["EditedEvents"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
}
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.mostRecentSimDayUsage)) {
            ...
            for (let item of this.mostRecentSimDayUsage)
                data["MostRecentSimDayUsage"].push(item ? item.toJSON() : <any>undefined);
        }
        super.toJSON(data);
        return data;
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.unscheduledRebookings)) {
            ...
            for (let item of this.unscheduledRebookings)
                data["UnscheduledRebookings"].push(item ? item.toJSON() : <any>undefined);
        }
        return data;
    }
}
            ...
            if (_data["NewExtraParts"]) {
                ...
                for (let key in _data["NewExtraParts"]) {
                    if (_data["NewExtraParts"].hasOwnProperty(key))
                        (<any>this.newExtraParts)![key] = _data["NewExtraParts"][key];
                }
            }
    ...
    toJSON(data?: any) {
        ...
        if (this.newExtraParts) {
            ...
            for (let key in this.newExtraParts) {
                if (this.newExtraParts.hasOwnProperty(key))
                    (<any>data["NewExtraParts"])[key] = (<any>this.newExtraParts)[key];
            }
        }
        if (Array.isArray(this.simStations)) {
            data["SimStations"] = [];
            for (let item of this.simStations)
                data["SimStations"].push(item ? item.toJSON() : <any>undefined);
        }
        if (Array.isArray(this.simStationsForExecutionOfCurrentStatus)) {
            ...
            for (let item of this.simStationsForExecutionOfCurrentStatus)
                data["SimStationsForExecutionOfCurrentStatus"].push(item ? item.toJSON() : <any>undefined);
        }
        if (Array.isArray(this.simDayUsage)) {
            data["SimDayUsage"] = [];
            for (let item of this.simDayUsage)
