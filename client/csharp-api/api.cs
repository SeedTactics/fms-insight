...
namespace BlackMaple.FMSInsight.API
{
    ...
    public partial class FmsClient 
    {
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/fms/enable-verbose-logging-for-five-minutes");
    ...
    public partial class JobsClient 
    {
        ...
        public virtual async System.Threading.Tasks.Task SignalMaterialForQuarantineAsync(long materialId, string operName, string reason, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/jobs/material/{materialId}/signal-quarantine?");
            urlBuilder_.Replace("{materialId}", System.Uri.EscapeDataString(ConvertToString(materialId, System.Globalization.CultureInfo.InvariantCulture)));
            if (operName != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("operName") + "=").Append(System.Uri.EscapeDataString(ConvertToString(operName, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
    ...
    public partial class LogClient 
    {
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<LogEntry>> RecentAsync(long lastSeenCounter, System.DateTimeOffset? expectedEndUTCofLastSeen, System.Threading.CancellationToken cancellationToken)
        {
            ...
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("expectedEndUTCofLastSeen") + "=").Append(System.Uri.EscapeDataString(expectedEndUTCofLastSeen.Value.ToString("yyyy-MM-ddTHH:mm:ssZ", System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            urlBuilder_.Length--;
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<MaterialDetails>> MaterialForSerialAsync(string serial, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/log/material-for-serial/{serial}");
            urlBuilder_.Replace("{serial}", System.Uri.EscapeDataString(ConvertToString(serial, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public virtual async System.Threading.Tasks.Task<LogEntry> RecordCloseoutCompletedAsync(NewCloseout insp, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/log/events/closeout");
        ...
        public virtual async System.Threading.Tasks.Task<LogEntry> RecordWorkorderCommentAsync(string workorder, string operatorName, string comment, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/log/workorder/{workorder}/comment?");
            urlBuilder_.Replace("{workorder}", System.Uri.EscapeDataString(ConvertToString(workorder, System.Globalization.CultureInfo.InvariantCulture)));
            if (operatorName != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("operatorName") + "=").Append(System.Uri.EscapeDataString(ConvertToString(operatorName, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
    ...
    public partial class FMSInfo
    {
        ...
        [Newtonsoft.Json.JsonProperty("AllowSwapAndInvalidateMaterialAtLoadStation", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool? AllowSwapAndInvalidateMaterialAtLoadStation { get; set; }
    ...
    {
        [Newtonsoft.Json.JsonProperty("PalletNums", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<int> PalletNums { get; set; }
