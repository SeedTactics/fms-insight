...
namespace BlackMaple.FMSInsight.API
{
    ...
    public partial class ServerClient 
    {
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task FindInstructionsAsync(string part, string type)
        {
            return FindInstructionsAsync(part, type, System.Threading.CancellationToken.None);
        }
    
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task FindInstructionsAsync(string part, string type, System.Threading.CancellationToken cancellationToken)
        {
            if (part == null)
                throw new System.ArgumentNullException("part");
