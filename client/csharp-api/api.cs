...
namespace BlackMaple.FMSInsight.API
{
    ...
    public partial class JobsClient 
    {
        ...
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<JobAndDecrementQuantity>> DecrementQuantitiesAsync(string loadDecrementsStrictlyAfterDecrementId, System.DateTime? loadDecrementsAfterTimeUTC, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (loadDecrementsStrictlyAfterDecrementId != null) urlBuilder_.Append("loadDecrementsStrictlyAfterDecrementId=").Append(System.Uri.EscapeDataString(ConvertToString(loadDecrementsStrictlyAfterDecrementId, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            if (loadDecrementsAfterTimeUTC != null) urlBuilder_.Append("loadDecrementsAfterTimeUTC=").Append(System.Uri.EscapeDataString(loadDecrementsAfterTimeUTC.Value.ToString("s", System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
    ...
    public partial class LogClient 
    {
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task GetEventCSVAsync(System.DateTime startUTC, System.DateTime endUTC)
        {
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task GetEventCSVAsync(System.DateTime startUTC, System.DateTime endUTC, System.Threading.CancellationToken cancellationToken)
        {
            if (startUTC == null)
                throw new System.ArgumentNullException("startUTC");
    ...
    public partial class ServerClient 
    {
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<WorkorderAssignmentType> WorkorderAssignmentTypeAsync()
        {
            return WorkorderAssignmentTypeAsync(System.Threading.CancellationToken.None);
        }
    
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<WorkorderAssignmentType> WorkorderAssignmentTypeAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/server/workorder-assignment-type");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = await response_.Content.ReadAsStringAsync().ConfigureAwait(false); 
                            var result_ = default(WorkorderAssignmentType); 
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<WorkorderAssignmentType>(responseData_, _settings.Value);
                                return result_; 
                            } 
                            catch (System.Exception exception_) 
                            {
                        ...
                        return default(WorkorderAssignmentType);
                    }
                    finally
                    {
                        if (response_ != null)
    ...
    public abstract partial class ValueType : System.ComponentModel.INotifyPropertyChanged
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.45.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class HistoricData : ValueType, System.ComponentModel.INotifyPropertyChanged
    {
    ...
    public partial class JobPlan : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        private JobHoldPattern _holdEntireJob = new JobHoldPattern();
        ...
        [Newtonsoft.Json.JsonProperty("HoldEntireJob", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.45.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class ProcessInfo : ValueType, System.ComponentModel.INotifyPropertyChanged
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.45.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class ProcPathInfo : ValueType, System.ComponentModel.INotifyPropertyChanged
    {
        ...
        private JobHoldPattern _holdMachining = new JobHoldPattern();
        private JobHoldPattern _holdLoadUnload = new JobHoldPattern();
        ...
        [Newtonsoft.Json.JsonProperty("HoldMachining", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        ...
        [Newtonsoft.Json.JsonProperty("HoldLoadUnload", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.45.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class FixtureFace : ValueType, System.ComponentModel.INotifyPropertyChanged
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.45.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class SimulatedProduction : ValueType, System.ComponentModel.INotifyPropertyChanged
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.45.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class PlannedSchedule : ValueType, System.ComponentModel.INotifyPropertyChanged
    {
    ...
    public partial class CurrentStatus : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        [Newtonsoft.Json.JsonProperty("LatestScheduleId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string LatestScheduleId
        {
            get { return _latestScheduleId; }
            set 
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.45.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class PalletLocation : ValueType, System.ComponentModel.INotifyPropertyChanged
    {
    ...
    public partial class InProcessMaterialLocation : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        [Newtonsoft.Json.JsonProperty("QueuePosition", Required = Newtonsoft.Json.Required.Always)]
    ...
    public partial class InProcessMaterialAction : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        [Newtonsoft.Json.JsonProperty("LoadOntoFace", Required = Newtonsoft.Json.Required.Always)]
        ...
        [Newtonsoft.Json.JsonProperty("ProcessAfterLoad", Required = Newtonsoft.Json.Required.Always)]
        ...
        [Newtonsoft.Json.JsonProperty("PathAfterLoad", Required = Newtonsoft.Json.Required.Always)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.45.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class JobAndDecrementQuantity : ValueType, System.ComponentModel.INotifyPropertyChanged
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.45.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class NewInspectionCompleted : ValueType, System.ComponentModel.INotifyPropertyChanged
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.45.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class NewWash : ValueType, System.ComponentModel.INotifyPropertyChanged
    {
        private LogMaterial _material = new LogMaterial();
    ...
    {
        [System.Runtime.Serialization.EnumMember(Value = "AssignWorkorderAtUnload")]
        AssignWorkorderAtUnload = 0,
    
        [System.Runtime.Serialization.EnumMember(Value = "AssignWorkorderAtWash")]
        AssignWorkorderAtWash = 1,
    
        [System.Runtime.Serialization.EnumMember(Value = "NoAutomaticWorkorderAssignment")]
        NoAutomaticWorkorderAssignment = 2,
